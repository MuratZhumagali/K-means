...
print(oldcenter2)
print(oldcenter3)
def manhattan(center):
    Result=[]
    for i in l:
        L=abs(center[0]-i[0])+abs(center[1]-i[1])
        Result.append(L)
    return Result
    
oldDistance1=manhattan(oldcenter1)
oldDistance2=manhattan(oldcenter2)
oldDistance3=manhattan(oldcenter3)
...
while(1):
    if (newcenter1==oldcenter1) and (newcenter2==oldcenter2) and (newcenter3==oldcenter3):
        ...
        count=count+1  
        newDistance1=manhattan(newcenter1)
        newDistance2=manhattan(newcenter2)
        newDistance3=manhattan(newcenter3)
